...
**双击任何一行**（手机上点一下；键盘选中后按 Enter）打开这支股票的完整图表和财报：
...
- 📊 **选股器式表格**：每支股票都有日内迷你走势图、相对成交量、多空标签，可排序可搜索；双击任何一行看完整 K 线图
...
+ docs/charts/table.json (表格股票的 6 个月日线 + 当天 5 分钟线，双击时才下载)
...
├── docs/charts/table.json       # "其余股票"双击看完整图表用的 K 线 (每次运行更新)
