...
- **颜色**：上涨 / 下跌 / EMA20 的颜色
- **技术指标**：按 趋势 / 动量 / 波动性 / 成交量 分类，共 20 个常用指标（包括一目均衡表 Ichimoku Cloud、Supertrend），点一下叠加到所有图上
...
- ⚙️ **网页端自定义**：内置 20 个常用指标（SAR、布林带、一目均衡表、Supertrend、RSI、MACD、KD、CCI、ATR、OBV、VWAP 等），也能自己输入公式；颜色可调；指标组合存成模板
