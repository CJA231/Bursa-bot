...
- **AI 点评**：DeepSeek 根据数据给出的一句话评价（仅供参考，可能出错）
...
### 📥 下载报告
页面上方「📥 下载报告」展开后，可以下载**最近 7 个交易日**的报告：
- **每天一份**：CSV / Excel / PDF 三种格式（同一天运行多次的话，保留的是当天最后一次的结果）
...
点页面上方的「⚙️ 图表设置」打开：
- **颜色**：上涨 / 下跌 / EMA20 的颜色
- **技术指标**：按 趋势 / 动量 / 波动性 / 成交量 分类，共 18 个常用指标，点一下叠加到所有图上
...
- ⚙️ **网页端自定义**：内置 18 个常用指标（SAR、布林带、RSI、MACD、KD、CCI、ATR、OBV、VWAP 等），也能自己输入公式；颜色可调
